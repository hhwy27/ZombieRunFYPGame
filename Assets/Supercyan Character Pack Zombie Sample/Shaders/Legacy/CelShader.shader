...
Shader "Supercyan/Legacy/CelShader"
{
	...
	SubShader
	{
		...
		#pragma target 3.0
			...
			#undef INTERNAL_DATA
			#undef WorldReflectionVec3tor
			#undef WorldNormalVec3tor
			#define INTERNAL_DATA half3 internalSurfaceTtoW0; half3 internalSurfaceTtoW1; half3 internalSurfaceTtoW2;
			#define WorldReflectionVec3tor(data,normal) reflect (data.worldRefl, half3(dot(data.internalSurfaceTtoW0,normal), dot(data.internalSurfaceTtoW1,normal), dot(data.internalSurfaceTtoW2,normal)))
			#define WorldNormalVec3tor(data,normal) half3(dot(data.internalSurfaceTtoW0,normal), dot(data.internalSurfaceTtoW1,normal), dot(data.internalSurfaceTtoW2,normal))
		#endif
		struct Input
		{
			float2 uv_texcoord;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 ase_worldNormal = WorldNormalVec3tor( i, float3( 0, 0, 1 ) );
...
Node;AmplifyShaderEditor.WorldNormalVec3tor;1;-3700.658,-428.4648;Float;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
